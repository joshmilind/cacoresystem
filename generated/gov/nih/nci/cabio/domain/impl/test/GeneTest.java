...
public class GeneTest extends TestCase{
    ...
    private static Logger _logger = Logger.getLogger(GeneTest.class);
    
	public static final Class CLASS = GeneTest.class;

    public GeneTest(String testName) {
        super(testName);
    }
	...
	public static junit.framework.Test suite() {
		...
		//suite.addTest(new GeneTest("testPopulate"));
		suite.addTest(new GeneTest("testRetrieve"));
	...
	public void testPopulate(){
		try{
		    ...
		    ex.printStackTrace();
		    fail("Error retrieving Gene. Got " + ex.getClass().getName() + ": " + ex.getMessage());
	...
	public void testRetrieve(){
		try{
			...
			sess.createCriteria(gov.nih.nci.cabio.domain.ws.Gene.class).list();
			tx.commit();
	...
	((gov.nih.nci.cabio.domain.ws.Gene)obj).setId(new java.lang.Long("1"));
