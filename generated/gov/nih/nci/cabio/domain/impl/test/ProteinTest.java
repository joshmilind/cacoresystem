...
public class ProteinTest extends TestCase{
    ...
    private static Logger _logger = Logger.getLogger(ProteinTest.class);
    
	public static final Class CLASS = ProteinTest.class;
	...
	public static junit.framework.Test suite() {
		...
		//suite.addTest(new ProteinTest("testPopulate"));
		suite.addTest(new ProteinTest("testRetrieve"));
	...
	public void testPopulate(){
		try{
		        gov.nih.nci.cabio.domain.ws.Protein protein = new gov.nih.nci.cabio.domain.ws.Protein() ;
			save(protein);
		}catch(Exception ex){
		    ex.printStackTrace();
		    fail("Error retrieving Protein. Got " + ex.getClass().getName() + ": " + ex.getMessage());
	...
	public void testRetrieve(){
		try{
			...
			sess.createCriteria(gov.nih.nci.cabio.domain.ws.Protein.class).list();
			tx.commit();
	...
	((gov.nih.nci.cabio.domain.ws.Protein)obj).setId(new java.lang.Long("1"));
