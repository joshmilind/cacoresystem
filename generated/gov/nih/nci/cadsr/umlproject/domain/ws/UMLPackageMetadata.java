...
public  class UMLPackageMetadata 
	...
	private static final long serialVersionUID = 1234567890L;
	   ...
	   public void setClassSchemeClassSchemeItem(gov.nih.nci.cadsr.domain.ws.ClassSchemeClassSchemeItem classSchemeClassSchemeItem){
		this.classSchemeClassSchemeItem = classSchemeClassSchemeItem;
			...
			private gov.nih.nci.cadsr.umlproject.domain.ws.SubProject subProject;
			public gov.nih.nci.cadsr.umlproject.domain.ws.SubProject getSubProject(){
			  return subProject;
                        }
	   ...
	   public void setSubProject(gov.nih.nci.cadsr.umlproject.domain.ws.SubProject subProject){
