...
public class ConceptTest extends TestCase{
    ...
    private static Logger _logger = Logger.getLogger(ConceptTest.class);
    
	public static final Class CLASS = ConceptTest.class;
	...
	public static junit.framework.Test suite() {
		...
		//suite.addTest(new ConceptTest("testPopulate"));
		suite.addTest(new ConceptTest("testRetrieve"));
	...
	public void testPopulate(){
		try{
		        gov.nih.nci.cadsr.domain.ws.Concept concept = new gov.nih.nci.cadsr.domain.ws.Concept() ;
			save(concept);
		}catch(Exception ex){
		    ex.printStackTrace();
		    fail("Error retrieving Concept. Got " + ex.getClass().getName() + ": " + ex.getMessage());
	...
	public void testRetrieve(){
		try{
			...
			sess.createCriteria(gov.nih.nci.cadsr.domain.ws.Concept.class).list();
			tx.commit();
	...
	((gov.nih.nci.cadsr.domain.ws.Concept)obj).setId(new java.lang.String("1"));
