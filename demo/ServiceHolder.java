 ...
 * @version subversion $Revision: 1.1 $ checked in on $Date: 2007-08-16 21:17:14 $
 */
public class ServiceHolder
{
    ...
    public void configureNext() throws LBException
    {
        ...
        lbsi_ = new LexBIGServiceImpl();
    }

    protected ArrayList<TestServerConfig> getServerConfigs()
    {
    ...
    private static Properties createPropertiesObject(TestServerConfig serverInfo, int i, File configFolder)
    {
        ...
        props.setProperty("JAR_FILE_LOCATION", "../../../lgSharedLibraries;../../extLib"); // assumes we are runnign in the eclipse workspace.
        ...
        props.setProperty("CONFIG_FILE_LOCATION", PropertiesUtility.locatePropFile("config"
                + System.getProperty("file.separator")
                + "config.props", ServiceHolder.class.getName())); // assumes we are running in the eclipse workspace
