<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="xlink" version="2.0">
  ...
  <!-- application hdr begins -->
  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="subhdrBG">
  		...
  		<img src="/@PROJECT_NAME@/images/cabio58.gif" alt="Application Logo" height="35" hspace="10" border="0"/></a>
  		<img src="/@PROJECT_NAME@/images/cadsr.gif" alt="Application Logo" height="35" hspace="10" border="0"/>			
		<img src="/@PROJECT_NAME@/images/evs.gif" alt="Application Logo" height="35" hspace="10" border="0"/>
		<img src="/@PROJECT_NAME@/images/csm.gif" alt="Application Logo" height="35" hspace="10" border="0"/>
		</td>  		
